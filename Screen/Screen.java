...
public class Screen {
	 ...
	 * 
	 * @param sizeX
	 *            screen size on X axis
	 * @param sizeY
	 *            screen size on Y axis
	 */
	 ...
	 * @param symbol
	 *            the symbol the line is drawn with
	 */
	 ...
	 * 
	 * @param startPoints
	 *            array of first ends of the lines
	 * @param endPoints
	 *            array of second ends of the lines
	 * @param symbol
	 *            the symbol with which ALL lines are drawn
	 */
