...
/**
 * Opens a file for reading and provides a stream of words resulting from its
 * parsing.
 */
public final class FileParser {
	 ...
	 * <p>
	 * This operation must be performed before calling any other methods on this
	 * object.
	 */
	public void open() {
		if (reader != null) {
	 ...
	 * 
	 * @return a word as a
	 *         <code>String<code>, or <code>null<code> if the end of the file has been
	 * reached.
	 */
